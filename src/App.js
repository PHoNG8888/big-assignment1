...
const App = () => {
  ...
  const handleAddExpense = () => {
    ...
    const listExpenseUp = [...listExpense];
    listExpenseUp.push(expense);
    setListExpense(listExpenseUp);
  };
  const handleDeleteExpense = (id) => {
    const listExpenseUp = { ...listExpense };
    const expneses = listExpenseUp.filter((element) => !(element.id == id));
    setListExpense(expneses);
